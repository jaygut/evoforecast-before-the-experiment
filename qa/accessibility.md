...
- Skip link, semantic `main`, twelve labelled `section` elements, one H1, ordered H2 hierarchy, and footer are present.
- All 12 source pills are links; all 12 provenance states and caveats are textual.
...
- No-JavaScript mode retained 12 titles, 12 source pills, claim boundary, caveats, links, and an ordered fallback summary.
