...
| 4 | windtunnel | Rehearse the whole experiment where the answer is already known, and compare learning, cost, and failure. | EF-013 (SLiM 5.2 sole engine), EF-002 | Where could leakage or a second simulator enter? |
...
| 10 | ladder | The software claim is solid; the biology claim is not, yet. | EF-002, EF-011, EF-015, EF-017 | Which rung is truly supported, and what would move the next one? |
...
5. **V3, V4, V5 are three distinct beats.** The positive control, the rejected cohort, and the scale-up
   ...
   negative) is legible. The day-90 52.5% nowcast is shown as too close to chance to act on.
...
7. **One biological boundary.** The site does not modify RC01 or implement GT01. The ten-chromosome
   cutaway is explicitly proposed and blocked and paired with the clonal RC01 boundary.
