...
LOCAL_URL = "file://" + str(SITE / "index.html")
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"

parser = argparse.ArgumentParser()
parser.add_argument("--url", default=LOCAL_URL, help="page URL; defaults to the local file artifact")
parser.add_argument("--report", default=str(SITE / "qa" / "file_smoke_v2.json"))
args = parser.parse_args()

res = {"target": "local index.html via file protocol" if args.url == LOCAL_URL else args.url,
