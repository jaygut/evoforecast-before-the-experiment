...
- The latest blind package completed 5,600 of 5,600 SLiM 5.2 trajectories with none failed.
...
- GT01/G1 qualification, exact founder/genome identity, and a calibrated
  ten-chromosome genome-to-phenome mechanism.
...
Run one small, staged, keystone-centered round: one candidate organism, one feasible
measurement budget, and one held-out challenge, rehearsed in the wind tunnel first,
